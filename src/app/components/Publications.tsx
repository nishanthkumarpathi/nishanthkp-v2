        ...
        <div className="mb-12">
          ...
          <div className="space-y-6">
            {patents.map((patent, index) => (
              <div
                key={index}
                className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow border-l-4 border-[#17A2B8]"
              >
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4">
                  <div className="flex-1">
                    <h4 className="text-xl font-medium text-gray-900 mb-2">{patent.title}</h4>
                    <span className="inline-block px-3 py-1 bg-[#17A2B8]/10 text-[#17A2B8] text-sm rounded-md mb-3">
                      {patent.type}
                    </span>
                  </div>
                ...
                <a
                  href={patent.link}
                  className="inline-flex items-center text-[#007BFF] hover:text-[#0056b3] transition-colors"
                  target="_blank"
            ...
            {papers.map((paper, index) => (
              ...
              >
                <div className="flex items-start mb-3">
                  <FileText className="text-[#007BFF] mr-2 flex-shrink-0 mt-1" size={20} />
                  <div>
              ...
              >
                <div className="flex items-center mb-3">
                  <div className="w-10 h-10 bg-[#001f3f]/10 rounded-full flex items-center justify-center mr-3">
                    <Award className="text-[#001f3f]" size={20} />
                  </div>
                  <div>
